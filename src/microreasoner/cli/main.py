...
from microreasoner.runtime.grpo_command import execute_grpo_command
...
def _add_train_subcommands(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    train_grpo.add_argument(
        "--dataset-manifest",
        required=True,
        help="Path to RL dataset manifest generated by data build-rl",
    )
    train_grpo.add_argument(
        "--init-checkpoint",
        required=True,
        help="Path to SFT checkpoint used as GRPO initialization",
    )
    train_grpo.add_argument("--run-id", required=False, help="Optional explicit run id")
    train_grpo.add_argument(
        "--resume-from",
        required=False,
        help="Optional GRPO checkpoint directory for resume",
    )
    train_grpo.add_argument(
        "--max-steps",
        required=False,
